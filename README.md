...
- **Break-even or worse:** docs you edit constantly (every edit re-translates the changed sections — incremental, but not free) and one-off reads.
- **Saves ~nothing:** code-heavy sessions that rarely `Read` Cyrillic markdown. If that's your workflow, this package is not for you.
